export const dubai = [
  {
    ...
    qna: [
      ...
      },
      {
        ...
        answer2:
          "A wonderful opportunity to discover the traditional city of merchants and modern Dubai. Our tour begins with a drive into the Palm Jumeirah dubbed as the eighth wonder of the world and head for a quick photostop in front of the Atlantis Hotel. We then drive towards the beautiful Jumeirah Mosque built in the year 1979 in the tradition of the fatimi mosques of Egypt. Our tour is headed towards the famous Sheikh Zayed road highway to view Burj Khalifa Tower, the tallest building in the world from a long distance. Our jounery continues towards the old part of the city where we pass impressive palaces of the ruling family of Dubai on our way to the famous Dubai Creek. Our guide then escorts us to the Dubai Museum and the Al Fahidi fort, which is a almost two centuries old and is a living monument of Dubai’s illustrious and prominent past. We then pay a visit to the famous gold and spice souk where bargains galore await. Your next stop is at a souvenir shop where you will have time to buy antiques, souvenirs, arts and crafts. Our city ends at the iconic Burj Al Arab hotel with a stop outside the hotel for photographs. Return to your hotel with wonderful memories.",
      },
      {
        question3:
